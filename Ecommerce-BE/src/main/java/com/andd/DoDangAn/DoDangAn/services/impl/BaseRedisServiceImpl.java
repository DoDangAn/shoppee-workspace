package com.andd.DoDangAn.DoDangAn.services.impl;

import com.andd.DoDangAn.DoDangAn.services.Cache.BaseRedisService;
...
public class BaseRedisServiceImpl implements BaseRedisService {
    ...
    @Override
    public void deleteByFieldPrefix(String key, String fieldPrefix) {
        Map<String, Object> hashEntries = hashOperations.entries(key);
        for (String field : hashEntries.keySet()) {
    ...
    @Override
    public void deleteByKey(String key, List<String> fields) {
